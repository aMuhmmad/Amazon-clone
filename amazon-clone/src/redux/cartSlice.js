...
const initialState = {
    products: localStorage.getItem('myCart') ? JSON.parse(localStorage.getItem('myCart')).products : [],
    productsNumber: localStorage.getItem('myCart') ? JSON.parse(localStorage.getItem('myCart')).productsNumber : 0
}
